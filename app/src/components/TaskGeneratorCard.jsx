...
export default function TaskGeneratorCard({
  onGenerateTasks,
  taskCount,
  onTaskCountChange,
  minTaskCount,
  ...
  return (
    <div className="rounded-xl border border-slate-400/20 bg-sky-mid/90 backdrop-blur-md p-5">
      <h2 className="text-lg font-bold mb-1">Plan your climb</h2>
      <p className="text-sm text-slate-400 mb-4">Generate tasks to reach your summit.</p>
